...
渐变过渡通常会逐渐从一种颜色变为另一种颜色。当需要更 abrupt 的变化时，可以使用硬停止来实现，如下所示：
...
为 [.bb2b](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98fb.md#L80-L80) 添加一个 `linear-gradient`，使用 `--building-color2` 从 `0%` 到 `6%` 以及 `--window-color2` 从 `6%` 到 `9%`。

# --hints--

你应该给 [.bb2b](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98fb.md#L80-L80) 一个 `background` 属性。
...
[.bb2b](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98fb.md#L80-L80) 应该有一个 `linear-gradient`，从 `0%` 到 `6%` 使用 `--building-color2`，从 `6%` 到 `9%` 使用 `--window-color2`。
