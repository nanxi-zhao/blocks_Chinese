...
在你刚刚添加的渐变下面再添加一个 [repeating-linear-gradient](#)。给它一个 [90deg](#) 的方向，颜色从 [0%](#) 到 [12%](#) 使用你的建筑颜色，从 [12%](#) 到 [44%](#) 使用窗户颜色 [--window-color2](#)。这将会创建一堆矩形窗户的效果。

# --hints--

你应该在 [.fb5](#) 的 [background](#) 属性中添加第二个 [repeating-linear-gradient](#)。
...
你应该给第二个 [repeating-linear-gradient](#) 设置方向为 [90deg](#)。
...
你应该给第二个 [repeating-linear-gradient](#) 设置第一个颜色为 [--building-color2](#)，范围从 [0%](#) 到 [12%](#)。
...
你应该给第二个 [repeating-linear-gradient](#) 设置第二个颜色为 [--window-color2](#)，范围从 [12%](#) 到 [44%](#)。
