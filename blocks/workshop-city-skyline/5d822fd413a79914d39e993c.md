...
太棒啦！现在让我们在媒体查询的 [`sky`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Class_selectors) 类中，将两个 `#ffcf33` 颜色值改为 `#ccc`，将 `#ffff66` 改为 `#445`，将 `#bbeeff` 改为 `#223` 吧。然后你就可以调整窗口大小来看背景颜色的变化啦！

# --hints--

你应该将第一个颜色值从 `#ffcf33` 改为 `#ccc`。
