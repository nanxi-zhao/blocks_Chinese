...
你的代码中不应该有 `discount = PercentageDiscount(10)` 这一行。
...
你的代码中不应该有 `print(discount.apply_discount(product))` 这一行。
...
你的代码中不应该有 `fixed_discount = FixedAmountDiscount(5)` 这一行。
...
你的代码中不应该有 `print(fixed_discount.apply_discount(product))` 这一行。
