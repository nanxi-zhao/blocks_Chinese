...
有趣的事实：大多数（如果不是全部）的鳍状肢天生就不是矩形的。

给[.arm](file:///f:/code/blocks_Chinese/blocks_english/workshop-flappy-penguin/619d2f0e9440bc27caee1cec.md#L275-L284)元素的左上角、右上角和右下角设置`30%`的圆角，左下角设置`120%`的圆角。

# --hints--

你应该给[.arm](file:///f:/code/blocks_Chinese/blocks_english/workshop-flappy-penguin/619d2f0e9440bc27caee1cec.md#L275-L284)设置`border-radius`为`30% 30% 30% 120%`。
