...
你的 `label` 元素应该包含文本 `Social Media Ads`。
...
```js
assert.strictEqual(document.querySelector("fieldset:nth-of-type(3) input[type='checkbox'] + label")?.htmlFor, "ads");
```
