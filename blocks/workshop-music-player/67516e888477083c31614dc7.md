...
太棒了！你做得很好！现在，如果你仔细观察，会发现当前播放的歌曲在播放列表中没有被高亮显示，所以你并不真正知道哪首歌正在播放。你可以通过创建一个函数来高亮显示任何正在播放的歌曲来解决这个问题。

创建一个名为[highlightCurrentSong](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516e888477083c31614dc7.md#L717-L717)的函数。在函数内部，检查是否存在带有`aria-current="true"`的`.playlist-song`元素。如果存在，使用[removeAttribute](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516e888477083c31614dc7.md#L717-L717)方法从该元素中移除`aria-current`属性。

# --hints--

你应该有一个名为[highlightCurrentSong](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516e888477083c31614dc7.md#L717-L717)的函数。

```js
assert.isFunction(highlightCurrentSong)
```

你的[highlightCurrentSong](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516e888477083c31614dc7.md#L717-L717)函数应该使用[removeAttribute](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516e888477083c31614dc7.md#L717-L717)方法，如果存在带有`aria-current="true"`的`.playlist-song`元素，则从该元素中移除`aria-current`属性。
