...
创建一个名为 [setPlayerDisplay](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的函数。在函数内部，将 [playingSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的 `textContent` 设置为当前歌曲的标题（如果已定义）。否则，将其设置为空字符串。

在下方，将 [songArtist](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的 `textContent` 设置为当前歌曲的艺术家（如果已定义）。否则，将其设置为空字符串。

# --hints--

你应该有一个名为 [setPlayerDisplay](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的函数。

```js
assert.isFunction(setPlayerDisplay);
```

你的 [setPlayerDisplay](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 函数应该将 [playingSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的 `textContent` 设置为当前歌曲的标题（如果已定义），或设置为空字符串。
...
你的 [setPlayerDisplay](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 函数应该将 [songArtist](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/6752c62efa90554c01415e7b.md#L719-L725) 的 `textContent` 设置为当前歌曲的艺术家（如果已定义），或设置为空字符串。
