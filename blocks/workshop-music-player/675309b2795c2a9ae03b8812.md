...
请注意，HTML中的专辑封面和[userData.songs](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L553-L589)数组中的歌曲已经发生了变化。我们已经将原始歌曲替换为较短的歌曲，你可以用来测试你的应用程序。

现在所有核心功能都已就位。现在唯一的问题是当前播放的歌曲结束时，下一首歌曲不会自动播放。

为了解决这个问题，你可以设置一个事件监听器来检测当前播放的歌曲何时结束。`"ended"`事件监听器适合这个用途。当媒体播放到达末尾时，它会被触发。

给[audio](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L588-L588)元素添加一个监听`"ended"`事件的事件监听器，并传入[playNextSong](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L635-L651)函数的引用。这样音乐播放器项目就完成了！

恭喜你！你已经成功地构建了一个功能完整的音乐播放器应用程序。通过添加"ended"事件监听器，你现在有了一个可以自动播放下一首歌曲的完整音乐播放器。你做得非常棒！

# --hints--

你应该将[addEventListener()](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6757f2b25418da4f73e29eb6.md#L741-L741)方法链接到你的[audio](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L588-L588)变量。

```js
assert.match(__helpers.removeJSComments(code), /audio\.addEventListener\(/)
```

你在[audio](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L588-L588)变量上使用的事件监听器应该监听`"ended"`事件。

```js
assert.match(__helpers.removeJSComments(code), /audio\.addEventListener\(\s*('|")ended\1/)
```

你应该将[playNextSong](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/675309b2795c2a9ae03b8812.md#L635-L651)的引用传递给你的`"ended"`事件监听器。
    ...
    <div class="player">
      ...
      <div class="player-content">
        <div id="player-album-art">
          <img src="https://cdn.MasterPuti.org/curriculum/js-music-player/digital-drift.jpg"
            alt="song cover art" />
        </div>
...
const allSongs = [
  {
    ...
    artist: "Rafael",
    duration: "0:23",
    src: "https://s3.amazonaws.com/org.freecodecamp.mp3-player/HelloWorld.mp3",
  },
  {
    id: 1,
    title: "In the Zone",
    artist: "Rafael",
    duration: "0:11",
    src: "https://s3.amazonaws.com/org.freecodecamp.mp3-player/IntheZone.mp3",
  },
  {
    id: 2,
    title: "Camper Cat",
    artist: "Rafael",
    duration: "0:21",
    src: "https://s3.amazonaws.com/org.freecodecamp.mp3-player/CamperCat.mp3",
  },
  {
    id: 3,
    title: "Electronic",
    artist: "Rafael",
    duration: "0:15",
    src: "https://s3.amazonaws.com/org.freecodecamp.mp3-player/Electronic.mp3",
  },
  {
    id: 4,
    title: "Sailing Away",
    artist: "Rafael",
    duration: "0:22",
    src: "https://s3.amazonaws.com/org.freecodecamp.mp3-player/SailingAway.mp3",
  }
];
