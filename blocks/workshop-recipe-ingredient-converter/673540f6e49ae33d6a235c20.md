...
你需要保留一个你的应用程序支持的单位列表。

声明一个 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组，并给它字符串值 `"cup"`、`"gram"`、`"ounce"` 和 `"teaspoon"`。

# --hints--

你应该声明一个 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 变量。

```js
assert.isDefined(units);
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 变量应该是一个数组。

```js
assert.isArray(units);
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组应该有四个元素。

```js
assert.lengthOf(units, 4);
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组应该包含字符串 `"cup"`。

```js
assert.include(units, "cup");
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组应该包含字符串 `"gram"`。

```js
assert.include(units, "gram");
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组应该包含字符串 `"ounce"`。

```js
assert.include(units, "ounce");
```

你的 [units](file:///e:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/node_modules/axios/lib/core/settle.js#L13-L22) 数组应该包含字符串 `"teaspoon"`。
