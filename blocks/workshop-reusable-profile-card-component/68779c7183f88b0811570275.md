...
# --description--
最后冲刺：在 `profiles` 数组中再加入 Tiffany 和 Doug 的对象：

- Tiffany: `id: 2`，`name: "Tiffany"`，`title: "Engineering manager"`，`bio: "I have worked in tech for 15 years and love to help people grow in this industry."`
- Doug: `id: 3`，`name: "Doug"`，`title: "Backend developer"`，`bio: "I have been a software developer for over 20 years and I love working with Go and Rust."`

保持 `map()` 渲染逻辑不变，现在页面应显示三张名片。🎉

至此，你的“可复用资料卡片组件”项目完美收官！记录一下你的进步吧，你真的太棒了！🌱🚀
