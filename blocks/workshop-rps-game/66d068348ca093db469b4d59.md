...
首先创建一个名为 `playerScoreSpanElement` 的变量，并将其赋值为具有 id `player-score` 的元素。

然后创建一个名为 `computerScoreSpanElement` 的变量，并将其赋值为具有 id `computer-score` 的元素。

最后，创建一个名为 `roundResultsMsg` 的变量，并将其赋值为具有 id `results-msg` 的元素。
...
你应该将具有 id `player-score` 的元素的值赋给 `playerScoreSpanElement`。
...
你应该将具有 id `computer-score` 的元素的值赋给 `computerScoreSpanElement`。
...
你应该将具有 id `results-msg` 的元素的值赋给 `roundResultsMsg`。
