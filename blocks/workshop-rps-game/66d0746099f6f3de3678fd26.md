...
现在是时候测试你的 `showResults` 函数了。

首先创建一个名为 `rockBtn` 的变量，并将其赋值为具有 id `rock-btn` 的按钮。

然后，创建一个名为 `paperBtn` 的变量，并将其赋值为具有 id `paper-btn` 的按钮。

最后，创建一个名为 `scissorsBtn` 的变量，并将其赋值为具有 id `scissors-btn` 的按钮。
...
你的 `rockBtn` 变量应该被赋值为具有 id `rock-btn` 的按钮。
...
你的 `paperBtn` 变量应该被赋值为具有 id `paper-btn` 的按钮。
...
你的 `scissorsBtn` 变量应该被赋值为具有 id `scissors-btn` 的按钮。
