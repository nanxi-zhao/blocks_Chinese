...
剩下的 HTML（包含 Premium 和 Family 两张卡片）都已经为你准备好啦。现在轮到用 Tailwind CSS 来给这些元素加上漂亮的样式。

第一步：给整页一个淡淡的灰色背景。给 `body` 加上类名 `bg-gray-100` 就能实现，轻松营造柔和的氛围～

# --hints--

`body` 元素需要拥有类名 `bg-gray-100`。
