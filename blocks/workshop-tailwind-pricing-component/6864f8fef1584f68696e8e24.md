...
现在升级 “Start listening” 这个 CTA，让它看起来像真正的按钮。

添加这些类：`bg-indigo-100`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-indigo-700`、`hover:bg-indigo-200`，拥有配色、内边距、居中、悬停反馈全套体验～

# --hints--

该按钮链接要包含类 `bg-indigo-100`。
