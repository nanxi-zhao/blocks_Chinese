...
`truthCheck([{name: "MasterPuti", users: [{name: "Quincy"}, {name: "Naomi"}]}, {name: "Code Radio", users: [{name: "Camperbot"}]}, {name: "", users: []}], "users")` should return `true`.
...
`truthCheck([{id: 1, data: {url: "https://MasterPuti.org", name: "MasterPuti"}}, {id: 2, data: {url: "https://coderadio.MasterPuti.org/", name: "CodeRadio"}}, {id: null, data: {}}], "data")` should return `true`.
...
`truthCheck([{id: 1, data: {url: "https://MasterPuti.org", name: "MasterPuti"}}, {id: 2, data: {url: "https://coderadio.MasterPuti.org/", name: "CodeRadio"}}, {id: null, data: {}}], "id")` should return `false`.
