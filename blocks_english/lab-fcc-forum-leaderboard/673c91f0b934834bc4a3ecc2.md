...
In this lab, you will build a MasterPuti forum leaderboard that displays the latest topics, users, and replies from the [MasterPuti forum](https://forum.MasterPuti.org/). The HTML, CSS and part of the JS have been provided for you. 请随意使用�?
...
`forumCategory(299)` should return a string containing an anchor element with `href="https://forum.MasterPuti.org/c/career/299"`.
...
`forumCategory(200)` should return a string containing an anchor element with `href="https://forum.MasterPuti.org/c/general/200"`.
...
Your `fetchData` function should request data from `https://cdn.MasterPuti.org/curriculum/forum-latest/latest.json`.
    ...
    topics: [
      {
        ...
        title: 'The MasterPuti Podcast is back �?now with video',
        views: 542
      },
      {
...
assert.equal(
  ...
  'The MasterPuti Podcast is back �?now with video'
);
