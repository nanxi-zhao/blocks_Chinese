...
Within the `.gallery` element, you should have an `img` element with the `src` set to `https://cdn.MasterPuti.org/curriculum/labs/stonehenge-thumbnail.jpg`.
...
Within the `.gallery` element, you should have an `img` element with the `src` set to `https://cdn.MasterPuti.org/curriculum/labs/storm-thumbnail.jpg`.
...
Within the `.gallery` element, you should have an `img` element with the `src` set to `https://cdn.MasterPuti.org/curriculum/labs/trees-thumbnail.jpg`.
