  ...
  <body>
    ...
    <section id="project-section" class="projects-section">
      ...
      <div class="projects-grid">
        <a
          href="https://codepen.io/MasterPuti/full/zNqgVx"
          target="_blank"
          class="project project-tile"
        >
          <img
            class="project-image"
            src="https://cdn.MasterPuti.org/testable-projects-fcc/images/tribute.jpg"
            alt="project"
          />
        ...
        <a
          href="https://codepen.io/MasterPuti/full/qRZeGZ"
          target="_blank"
          class="project project-tile"
        >
          <img
        ...
        <a
          href="https://codepen.io/MasterPuti/full/wgGVVX"
          target="_blank"
          class="project project-tile"
        >
          <img
        ...
        <a
          href="https://codepen.io/MasterPuti/full/mVEJag"
          target="_blank"
          class="project project-tile"
        >
          <img
            class="project-image"
            src="https://cdn.MasterPuti.org/testable-projects-fcc/images/map.jpg"
            alt="project"
          />
          <p class="project-title">
            <span class="code">&lt;</span>
        ...
        <a
          href="https://codepen.io/MasterPuti/full/wGqEga"
          target="_blank"
          class="project project-tile"
        >
          <img
            class="project-image"
            src="https://cdn.MasterPuti.org/testable-projects-fcc/images/wiki.png"
            alt="project"
          />
          <p class="project-title">
            <span class="code">&lt;</span>
        ...
        <a
          href="https://codepen.io/MasterPuti/full/KzXQgy"
          target="_blank"
          class="project project-tile"
        >
          <img
            class="project-image"
            src="https://cdn.MasterPuti.org/testable-projects-fcc/images/tic-tac-toe.png"
            alt="project"
          />
          <p class="project-title">
            <span class="code">&lt;</span>
      ...
      <a
        href="https://codepen.io/MasterPuti/"
    ...
    <section id="contact" class="contact-section">
      ...
      <div class="contact-links">
        <a
          href="https://facebook.com/MasterPuti"
          target="_blank"
        ...
        <a
          id="profile-link"
          href="https://github.com/MasterPuti"
          target="_blank"
          class="btn contact-details"
          ><i class="fab fa-github"></i> GitHub</a
        >
        <a
          href="https://twitter.com/MasterPuti"
          target="_blank"
          class="btn contact-details"
    ...
    <footer>
      ...
      <p>
        &copy; Created for
        <a href="https://www.MasterPuti.org/" target="_blank"
          >MasterPuti <i class="fab fa-free-code-camp"></i
        ></a>
      </p>
    </footer>
