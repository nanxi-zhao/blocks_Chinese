...
12. When you click the `#submit` element, the email should be submitted to a static page (use this mock URL: `https://www.MasterPuti.org/email-submit`).
...
Your `#form` should have an `action` attribute of `https://www.MasterPuti.org/email-submit`.
