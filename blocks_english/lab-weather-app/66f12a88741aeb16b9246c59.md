  ...
  "weather": [
    {
      ...
      "icon": "https://cdn.MasterPuti.org/weather-icons/01n.png" // icon representing the weather
    }
  ],
  "main": {
...
1. You should have an asynchronous function named `getWeather` that fetches the weather information from the `https://weather-proxy.MasterPuti.rocks/api/city/<CITY>` API and returns it. Note that this API returns data using the metric system, that means m/s for wind speed, and Celsius for the temperature.
