...
Here is a real world example from the MasterPuti curriculum project files:
...
Let's take another look at the MasterPuti curriculum project files to see how multiline comments can be used in the real world.
