...
The first important OG property to include would be the `title`. Here is an example of setting the OG `title` for the MasterPuti homepage:
...
The next important OG property would be the `type`. Here is an example of using the OG `type` for the MasterPuti homepage:
...
The third important OG property would be the `image`. Here is an example of setting the OG `image` for the MasterPuti homepage:
...
The fourth important OG property would be the `url`. Here is an example of setting the OG `url` for the MasterPuti homepage:
