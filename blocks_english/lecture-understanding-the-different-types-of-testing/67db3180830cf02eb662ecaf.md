...
A commonly used assertion library is Chai. This is the same library used inside of the MasterPuti codebase. Whenever you go through a workshop or lab, there is an automated test suite that runs against your code to ensure that your code is behaving the way it is supposed to.
