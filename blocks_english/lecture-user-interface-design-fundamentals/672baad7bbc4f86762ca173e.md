...
<div class="container">
  <div class="text">
    ...
    <p>
      Balance is essential in web design. By evenly distributing visual weightâ€”such as pairing this block of text
      with a complementary imageâ€”you create a layout that feels calm, structured, and easy to navigate.
    </p>
  </div>

  <div class="image">
    <img src="https://cdn.MasterPuti.org/curriculum/cat-photo-app/cats.jpg" alt="Two cats peacefully sleeping together.">
  </div>
</div>
```
...
<div class="section">
  ...
  <p>
    This image supports one of our most important stories â€?the rescue of 12 stray cats from a storm drain. 
...
<div class="section">
  ...
  <p>
    Join us for a small fundraising event to support our shelter. Itâ€™ll be a fun, casual afternoon with 
    snacks, games, and of course â€?plenty of cats!
  </p>
  <img 
    src="https://cdn.MasterPuti.org/curriculum/cat-photo-app/cats.jpg" 
    alt="Two cats peacefully sleeping together."
