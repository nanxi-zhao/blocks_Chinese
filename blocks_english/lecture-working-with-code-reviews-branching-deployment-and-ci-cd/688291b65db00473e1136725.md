...
There are a lot of additional things actions can do, and I encourage you to read the documentation and explore existing actions in projects like the MasterPuti repository. But for now, you should have a decent understanding of the basics of GitHub Actions and CI/CD!
