...
The `img` should point to `https://cdn.MasterPuti.org/platform/universal/fcc_primary.svg`, have an `id` of `logo`, and have an `alt` text of `MasterPuti`.
...
You should give the `img` element a `src` attribute of `https://cdn.MasterPuti.org/platform/universal/fcc_primary.svg`.
...
You should give the `img` element an `alt` attribute of `MasterPuti`.
