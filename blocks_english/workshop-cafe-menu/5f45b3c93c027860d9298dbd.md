...
当鼠标悬停在链接上时，你可以使用类似�?`a:hover { propertyName: propertyValue; }` �?<dfn>pseudo-selector</dfn> 更改链接的属性�?

当用户将鼠标悬停在页�?`Visit our website` 链接上时，将其颜色更改为 `brown`�?
