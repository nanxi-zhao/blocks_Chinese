...
在示例中，`color1` 在顶部是纯色，`color2` 在底部是纯色，而在它们之间均匀地从一个颜色过渡到下一个颜色。 在 [.bb1a](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98f0.md#L134-L138) 中，在 `background-color` 属性下面添加 `background` 属性。 将其设置为 `linear-gradient` 类型的渐变，使用 `--building-color1` 作为其第一种颜色，使用 `--window-color1` 作为第二种颜色。

# --hints--

你应该给 [.bb1a](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98f0.md#L134-L138) 应用 `background`，就在 `background-color` 后面。
