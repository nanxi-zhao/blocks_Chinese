...
Remove `orange` from the [.bb1d](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98f7.md#L125-L133) gradient and change the `80%` to `50%`. This will make `--building-color1` solid for the top half, and then transition to `--window-color1` for the bottom half.
