...
You should change the `background` property of [.bb2b](file:///e:/1.work/byy/在线课程/blocks/blocks_english/workshop-city-skyline/5d822fd413a79914d39e98fc.md#L45-L45) from using `linear-gradient` to using `repeating-linear-gradient`.
