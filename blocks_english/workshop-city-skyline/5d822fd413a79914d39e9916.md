...
不用担心底部的空间，当你给建筑物顶部的元素添加一些高度时，一切都会向下移动。

给 [.fb1c] 添加一个 [repeating-linear-gradient]，角度为 [90deg]，颜色为 [--building-color4]，从 [0%] 到 [10%]，然后 [transparent] 从 [10%] 到 [15%]。

# --hints--

你应该给 [.fb1c] 的 [background] 添加一个 [repeating-linear-gradient]。
...
你应该使用第一种颜色 [--building-color4]，从 [0%] 到 [10%]。
...
你应该使用第二种颜色 [transparent]，从 [10%] 到 [15%]。
