...
你可以通过用逗号（[,]）分隔多个渐变来将它们添加到一个元素中，如下所示：
...
在 [.fb1c] 中已有的渐变下方添加一个 [repeating-linear-gradient]；使用 [--building-color4] 从 [0%] 到 [10%]，以及 [--window-color4] 从 [10%] 到 [90%]。这将填充在你最后添加的渐变后面。

# --hints--

你不应该修改第一个 [repeating-linear-gradient]。
...
你应该添加一个 [repeating-linear-gradient]，第一种颜色 [--building-color4] 从 [0%] 到 [10%]。
...
你应该使用第二种颜色 [--window-color4] 从 [10%] 到 [90%]。
