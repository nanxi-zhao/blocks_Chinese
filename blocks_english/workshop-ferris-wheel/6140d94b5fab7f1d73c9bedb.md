...
`@keyframes` rules require a name to be assigned to them, which you use in other rules to reference. For example, the `@keyframes MasterPuti { }` rule would be named `MasterPuti`.
