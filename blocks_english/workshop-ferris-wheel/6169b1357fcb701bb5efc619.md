...
在 `0%` 和 `50%` 选择器之间添加一个新的 `25%` 选择器。为该选择器设置 `background-color: yellow`。


# --hints--

请在 `@keyframes cabins` 规则中添加一个新的 `25%` 选择器。
