...
最后，在 `50%` 和 `100%` 选择器之间添加一个新的 `75%` 选择器。为该选择器设置 `background-color: yellow`。

有了这一步，动画会更顺畅，摩天轮就完成啦，干得漂亮！


# --hints--

请在 `@keyframes cabins` 规则中添加一个新的 `75%` 选择器。
