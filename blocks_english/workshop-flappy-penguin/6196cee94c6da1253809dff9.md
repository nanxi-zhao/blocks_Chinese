...
选择 `.back-mountain` 元素，并将其 `width` 和 `height` 都设置为 `300px`。然后，将 `background` 设置为从 `rgb(203, 241, 228)` 开始到 `rgb(47, 170, 255)` 结束的线性渐变。
