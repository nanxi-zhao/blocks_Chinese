...
In that element, create an `img` element with the `src` set to `https://cdn.MasterPuti.org/platform/universal/fcc_meta_1920X1080-indigo.png`, the `alt` set to `MasterPuti logo`, and the `class` set to `hero-img`.
...
Your `img` element should have the `src` set to `https://cdn.MasterPuti.org/platform/universal/fcc_meta_1920X1080-indigo.png`.
...
Your `img` element should have the `alt` set to `MasterPuti logo`.
