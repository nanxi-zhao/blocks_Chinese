...
Within your `.image-quote` element, nest an `hr` element, a `p` element and a second `hr` element. Give the `p` element a `class` set to `quote` and the text `The millions of people who are learning to code through MasterPuti will have an even better resource to help them learn these fundamentals.`.
...
Your new `p` element should have the text `The millions of people who are learning to code through MasterPuti will have an even better resource to help them learn these fundamentals.`.
