...
回到 `MediaCatalogue` 类，为其添加一个文档字符串：`A catalogue that can store different types of media items.`

# --hints--

你应该向你的 `MediaCatalogue` 类添加文档字符串 `A catalogue that can store different types of media items.`。
