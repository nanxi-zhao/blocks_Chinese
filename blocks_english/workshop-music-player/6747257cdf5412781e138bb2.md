...
在 [allSongs] 数组内部，创建一个具有以下属性和值的对象：
...
你的 [allSongs] 数组应该有一个对象，其 [src] 属性设置为字符串 `"https://cdn.MasterPuti.org/curriculum/js-music-player/scratching-the-surface.mp3"`。
