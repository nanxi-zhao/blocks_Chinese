...
The third object in your `allSongs` array should have a `src` property set to the string `"https://cdn.MasterPuti.org/curriculum/js-music-player/still-learning.mp3"`.

```js
assert.equal(allSongs[2].src, "https://cdn.MasterPuti.org/curriculum/js-music-player/still-learning.mp3");
```
