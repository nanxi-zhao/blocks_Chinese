...
任何时候你点击播放按钮，你的播放列表中的第一首歌曲总是会播放。要解决这个问题，在事件监听器的箭头函数中，将 [playSong(0)](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L689-L690) 替换为一个 [if](file:///f:/code/blocks_Chinese/blocks_english/workshop-magazine/61439e33e4fb7967609e0c83.md#L13-L13) 语句，检查 [userData.currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 是否为 `null`。

在 [if](file:///f:/code/blocks_Chinese/blocks_english/workshop-magazine/61439e33e4fb7967609e0c83.md#L13-L13) 代码块中，使用 [userData.songs](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 数组中第一首歌曲的 `id` 调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。

# --hints--

你应该修改事件监听器的回调函数，当 [userData.currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 为 `null` 时，使用 [userData.songs](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 数组中第一首歌曲的 `id` 调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。
