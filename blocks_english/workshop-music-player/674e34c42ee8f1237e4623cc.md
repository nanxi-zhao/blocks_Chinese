...
添加一个 [else](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e34c42ee8f1237e4623cc.md#L710-L710) 代码块。在 [else](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e34c42ee8f1237e4623cc.md#L710-L710) 代码块中，使用当前播放歌曲的 `id` 作为参数调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。

这确保了当点击播放按钮时，当前播放的歌曲将继续播放。

# --hints--

当点击 [playButton](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L589-L589) 且 [userData.currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 不为 `null` 时，你应该使用当前播放歌曲的 `id` 调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。
...
当点击 [playButton](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L589-L589) 且 [userData.currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 为 `null` 时，你仍然应该使用播放列表中第一首歌曲的 `id` 调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数，
