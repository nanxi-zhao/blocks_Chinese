...
现在，创建一个名为 [getNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 的函数。让它返回在 [userData.songs](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 中 [getCurrentSongIndex()](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f489bf617af2bea9b92b5.md#L703-L703) 加一位置的歌曲，或者如果当前歌曲是播放列表中的最后一首，则返回 `undefined`。

# --hints--

你应该有一个名为 [getNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 的函数。

```js
assert.isFunction(getNextSong);
```

你的 [getNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 函数应该调用 [getCurrentSongIndex](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f489bf617af2bea9b92b5.md#L703-L703)。
...
你的 [getNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 函数应该返回当前歌曲的下一首歌曲。
...
你的 [getNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 函数应该在当前歌曲是播放列表中的最后一首时返回 `undefined`。
