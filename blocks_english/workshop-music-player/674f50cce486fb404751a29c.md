...
现在你知道如何找到要播放的下一首歌曲了，创建一个名为 [playNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 的函数。在 [playNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 函数内部，创建一个 [if](file:///f:/code/blocks_Chinese/blocks_english/workshop-magazine/61439e33e4fb7967609e0c83.md#L13-L13) 语句来检查 [userData](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 的 [currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 是否严格等于 `null`。这将检查 [userData](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 对象中当前是否有歌曲正在播放。

如果条件为真，使用 [userData.songs](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 数组中第一首歌曲的 `id` 作为参数调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。

# --hints--

你应该有一个名为 [playNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 的函数。

```js
assert.isFunction(playNextSong);
```

当 [userData](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 的 [currentSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 严格等于 `null` 时，你的 [playNextSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674f534fa181f64a789ffcf9.md#L758-L763) 函数应该使用 [userData.songs](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L668-L672) 数组中第一首歌曲的 `id` 作为参数调用 [playSong](file:///f:/code/blocks_Chinese/blocks_english/workshop-music-player/674e316e3892d32108ad2bb9.md#L674-L694) 函数。
