...
最后，将 `false` 作为第二个参数传递给 [playSong(userData.currentSong.id)](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/67516ca9b7fe6636208c5ab5.md#L706-L706) 函数调用。然后，通过播放一首歌曲，暂停它，然后按上一首按钮或下一首按钮来测试一切是否正常工作。
