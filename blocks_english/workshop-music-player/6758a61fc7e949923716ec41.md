...
现在，使用[querySelectorAll](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6758a61fc7e949923716ec41.md#L687-L689)方法定位`.playlist-song`元素并将它们存储在名为[songs](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6758a61fc7e949923716ec41.md#L687-L689)的变量中。

然后，调用[songs](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6758a61fc7e949923716ec41.md#L687-L689)上的[forEach](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6758a61fc7e949923716ec41.md#L745-L751)方法。传入一个使用[song](file:///E:/1.work/byy/%E5%9C%A8%E7%BA%BF%E8%AF%BE%E7%A8%8B/blocks/blocks_english/workshop-music-player/6758a61fc7e949923716ec41.md#L687-L689)作为方法参数的回调函数。现在让大括号保持为空。
...
你应该将所有 `.playlist-song` 元素的集合分配给你的 `songs` 变量。

```js
assert.deepEqual(songs, document.querySelectorAll(".playlist-song"));
```

你应该调用 `songs` 上的 `forEach` 方法，并传入一个使用 `song` 作为方法参数的回调。
