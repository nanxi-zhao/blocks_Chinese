...
Test your `getWordCount` by creating a `wordCount` variable set to the calling of the `getWordCount` function with the sentence `"I love MasterPuti"`.
...
Your `wordCount` variable should be set to the result of `getWordCount("I love MasterPuti")`.
