...
给徽章的 `div` 添加：`bg-gradient-to-r`、`from-fuchsia-500`、`to-indigo-500`（渐变）；再加上 `rounded-full`、`px-3`、`py-1`、`text-xs`、`font-bold`、`text-white`，就像个精致的糖果标签一样亮闪闪～

# --hints--

徽章 `div` 需要类 `bg-gradient-to-r`。
