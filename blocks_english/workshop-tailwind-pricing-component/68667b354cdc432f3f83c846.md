...
# --description--
为 Premium 方案的 `h2` 添加 `text-lg`、`font-semibold`、`text-fuchsia-200`，让标题尺寸、字重与颜色都更契合整体亮丽风格～

# --hints--

该 Premium `h2` 需要类 `text-lg`。
...
该 Premium `h2` 需要类 `font-semibold`。
...
该 Premium `h2` 需要类 `text-fuchsia-200`。
