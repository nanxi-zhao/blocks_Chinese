...
# --description--
接着用网格来安排 Family 卡片内部布局：给外层 `div` 添加 `grid`、`grid-rows-[1fr_auto]`、`gap-6`，内容与按钮分区明确、间距舒服～

# --hints--

Family 外层 `div` 需要类 `grid`。
...
Family 外层 `div` 需要类 `grid-rows-[1fr_auto]`。
