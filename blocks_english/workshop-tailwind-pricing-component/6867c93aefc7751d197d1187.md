...
# --description--
现在美化 Family 方案的标题：给该 `h2` 添加 `text-lg`、`font-semibold`、`text-indigo-600`，清晰稳重又不失活力～

# --hints--

Family 的 `h2` 需要类 `text-lg`。
...
Family 的 `h2` 需要类 `text-indigo-600`。
