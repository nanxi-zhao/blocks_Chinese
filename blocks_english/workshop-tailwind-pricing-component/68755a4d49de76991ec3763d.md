...
# --description--
最后给 Family 价格里的周期 `span` 添加 `text-base`、`font-medium`、`text-gray-500`，与主价格形成层次区分、信息更清晰～

# --hints--

该周期 `span` 需要类 `text-base`。
