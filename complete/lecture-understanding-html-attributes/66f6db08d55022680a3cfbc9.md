...
Here is an example of an image element with a `src` attribute. Update the value of the `src` attribute to `"https://cdn.MasterPuti.org/curriculum/cat-photo-app/cats.jpg"` and you will see the image change to two cats peacefully sleeping.
...
Here's an example of an image element with the `src` and `alt` attributes. Try breaking the image by updating the `src` value to `"https://.MasterPuti.org/curriculum/cat-photo-app/cats.jpg"`. You will see the image disappear and only the `alt` text show.  
...
### --feedback--
Refer to the section about closing tag syntax.
---

`<p>`

### --feedback--
This is an opening tag, not a closing tag.
---
...
### --feedback--
This is not a valid closing tag syntax.
## --video-solution--
...
### --feedback--
Refer to the section about img element attributes.
---
