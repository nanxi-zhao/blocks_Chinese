...
看看预览窗口中的链接。它应该是代表默认状态的蓝色。如果你点击它，它会变成紫色。
...
点击预览窗口中的链接，你应该看到访问过的链接变成棕色。

**注意**：为此交互示例提供了一些 CSS，这样你就可以看到链接样式的变化。不用担心试图理解 CSS 代码，因为你将在未来的模块中学习它的含义。
...
点击预览窗口中的任何空白区域，然后按键盘上的 `tab` 键。你应该看到链接变成绿色。
...
点击链接，你应该看到链接变成黑色。这发生得很快，所以你可能需要点击它几次才能看到颜色变化。
