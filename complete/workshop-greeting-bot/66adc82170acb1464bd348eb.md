...
机器人的最后几条消息将关注机器人最喜欢的科目。

首先创建一个名为 `favoriteSubject` 的新变量，并将其赋值为字符串 `"Computer Science"`。

# --hints--

你应该有一个名?`favoriteSubject` 的变量?
...
你应该将字符?`"Computer Science"` 赋值给 `favoriteSubject` 变量?
