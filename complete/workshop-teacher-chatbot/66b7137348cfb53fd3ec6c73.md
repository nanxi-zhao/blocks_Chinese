...
继续玩转 `indexOf` 吧！先添加一条 `console.log`，输出 `learningIsFunSentence.indexOf("fun")`，再添加一条 `console.log`，输出 `learningIsFunSentence.indexOf("learning")`。注意观察它们输出的不同结果——小发现很有趣！
