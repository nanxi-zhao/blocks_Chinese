...
鎶婂師鏉ュ湪鎻愪氦鍚庡垏?`taskForm` ?`hidden` 绫荤殑閭ｈ浠ｇ爜鍒犻櫎锛屾敼涓鸿皟?`reset` 鍑芥暟銆傝繖鏍锋棦鑳芥竻绌鸿緭鍏ユ锛屽張鑳藉叧闂脊绐楋紝璁╃敤鎴烽┈涓婄湅鍒版柊澧炰换鍔°€傚姛鑳介泦涓埌涓€涓皬鍔╂墜閲岋紝缁存姢鏇磋交鏉撅紝缁х画鍐插憖?
# --hints--

浣犲簲璇ュ垹闄ら偅琛屽垏?`taskForm` ?`hidden` 绫荤殑浠ｇ爜?
```js
